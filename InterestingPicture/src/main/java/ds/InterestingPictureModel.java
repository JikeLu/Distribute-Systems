    ...
    private String fetch(String urlString) {
        ...
        try {
            ...
            while ((str = in.readLine()) != null) {
                ...
                response += str;
            } // Used to read the response from the server line by line and concatenates it into the response string. str value represents a single line of text from the HTTP response body.
            in.close();
        } catch (IOException e) {
